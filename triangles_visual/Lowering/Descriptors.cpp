...
DescriptorSetLayout::DescriptorSetLayout(Device &device,
    ...
    if (vkCreateDescriptorSetLayout(device_.device(), &descriptorSetLayoutInfo, nullptr, &descriptorSetLayout) !=
        VK_SUCCESS) {
...
void DescriptorPool::resetPool() { vkResetDescriptorPool(device_.device(), descriptorPool, 0); }
...
void DescriptorWriter::overwrite(VkDescriptorSet &set) {
    ...
    vkUpdateDescriptorSets(pool.device_.device(), writes.size(), writes.data(), 0, nullptr);
}
