...
Device::Device(WindowInfo &window) : window_(window) {
    createInstance();      // done
...
void Device::createInstance() {
    ...
    appInfo.pApplicationName = "Triangle visualization";
...
void Device::createSurface() { window_.createWindowSurface(instance, &surface_); }
